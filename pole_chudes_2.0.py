...
def nachalo():
    try:
        global isp, d, slovo, bukvi, c, batl, izvestnie, win_phrases, ail_phrases, wrong_letter_phrases, right_letter_phrases, win_by_letters_phrases, fail_phrases
        ...
        if vibor == 3:
            slovo = input('Введите слово (пожалуйста вводите существующие слова и без ошибок): ')
            slovo = slova[random.randint(0, 2114)]
            bukvi = len(slovo)
            c = slovo
            slovo = list(slovo)
