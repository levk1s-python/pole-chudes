...
slova = [
    ...
    "состояние", "задача", "информация", "театр", "внимание", "производство", "квартира", "труд", "тело", "письмо",
    ...
    "встреча", "принцип", "событие", "структура", "количество", "товарищ", "создание", "значение", "объект", "гражданин",
    ...
    "класс", "зал", "изменение", "большинство", "характер", "кровь", "направление", "позиция", "герой", "течение",
    ...
    "спектакль", "руководство", "солнце", "автомобиль", "родитель", "участник", "журнал", "база", "пространство", "защита",
    ...
    "возраст", "комплекс", "бюджет", "представление", "площадь", "генерал", "господин", "дочь", "понятие", "кабинет",
    "безопасность", "фонд", "сфера", "папа", "сотрудник", "продукция", "будущее", "продукт", "содержание", "художник",
    ...
    "определение", "мужик", "обеспечение", "обстоятельство", "работник", "разработка", "лист", "звезда", "гора", "применение",
    ...
    "стоимость", "коридор", "ошибка", "лидер", "карта", "заседание", "глубина", "хлеб", "поверхность", "энергия",
    "нарушение", "реализация", "революция", "поведение", "профессор", "исполнение", "заместитель", "суть", "станция", "реакция",
    "десяток", "столица", "формирование", "поколение", "дума", "существование", "продажа", "список", "способность", "противник",
    ...
    "дядя", "милиция", "растение", "существо", "черт", "бабушка", "законодательство", "собственность", "отрасль", "слеза",
    "волна", "стекло", "традиция", "январь", "оборудование", "зависимость", "фраза", "декабрь", "сведение", "трубка",
    "сентябрь", "университет", "командир", "храм", "повышение", "стиль", "артист", "больница", "одежда", "охрана",
    ...
    "князь", "фотография", "весна", "помещение", "эпоха", "занятие", "произведение", "концерт", "ладонь", "дама",
    "сомнение", "американец", "середина", "зарплата", "тайна", "запад", "июнь", "беседа", "фронт", "поезд",
    "должность", "баба", "промышленность", "музей", "судья", "получение", "полковник", "зритель", "секретарь", "установка",
    "поток", "ценность", "образец", "страница", "перспектива", "трава", "чиновник", "мозг", "сотня", "лагерь",
    "выступление", "оборона", "постановление", "честь", "настроение", "кровать", "характеристика", "обязанность", "шея", "крыша",
    ...
    "сутки", "еврей", "конкурс", "открытие", "телевизор", "лошадь", "температура", "приказ", "лестница", "реклама",
    "спор", "подруга", "угроза", "конфликт", "изучение", "вино", "концепция", "достижение", "сообщение", "объединение",
    "обстановка", "костюм", "ключ", "ресторан", "назначение", "царь", "воспоминание", "увеличение", "вкус", "мероприятие",
    "лоб", "слой", "восток", "последствие", "принятие", "сотрудничество", "нефть", "слух", "бок", "переговоры",
    "тюрьма", "кандидат", "просьба", "реальность", "подарок", "категория", "потребность", "быль", "редакция", "очко",
    "километр", "губернатор", "новость", "инструмент", "потеря", "взаимодействие", "звонок", "кусок", "капитал", "грех",
    ...
    "устройство", "палата", "площадка", "опасность", "пропасть", "воздействие", "разница", "родственник", "сезон", "издание",
    ...
    "длина", "давление", "двигатель", "камера", "обращение", "формула", "запись", "крыло", "поездка", "гостиница",
    "колесо", "разрешение", "торговля", "академия", "доклад", "общение", "присутствие", "процедура", "испытание", "нож",
    "проверка", "коммунист", "цифра", "полет", "стакан", "эффективность", "обучение", "портрет", "достоинство", "рассмотрение",
    "владелец", "жилье", "компьютер", "корень", "смена", "доказательство", "кадр", "лейтенант", "признание", "темнота",
    "пистолет", "наблюдение", "мост", "ремонт", "истина", "вход", "политик", "живот", "кредит", "шум",
    "обед", "недостаток", "памятник", "вершина", "серия", "эксперимент", "сущность", "транспорт", "инициатива", "активность",
    ...
    "постель", "выпуск", "дворец", "брак", "прокурор", "печать", "окончание", "автомат", "тенденция", "следователь",
    ...
    "обсуждение", "сделка", "обязательство", "расстояние", "отдых", "телевидение", "тетя", "яблоко", "свидетель", "монастырь",
    "чтение", "параметр", "кампания", "помощник", "полк", "мощность", "сюжет", "потолок", "регистрация", "майор",
    "эксплуатация", "озеро", "новое", "атмосфера", "премия", "совесть", "предприниматель", "мальчишка", "дочка", "приятель",
    "начальство", "препарат", "село", "обработка", "танк", "милиционер", "ручка", "возвращение", "прокуратура", "ворота",
    "молоко", "еда", "сказка", "краска", "хвост", "сигарета", "введение", "покупатель", "поворот", "москвич",
    "ограничение", "инвестиция", "нация", "набор", "поселок", "дыхание", "адвокат", "сумка", "пресса", "корреспондент",
    "песок", "удивление", "потребитель", "указание", "изображение", "счастье", "мэр", "согласие", "действительность", "планета",
    "агентство", "танец", "библиотека", "финансирование", "объяснение", "распределение", "конституция", "таблица", "поэзия", "термин",
    "прибыль", "стандарт", "восторг", "гибель", "изделие", "темп", "вооружение", "осуществление", "уход", "чемпионат",
    "молитва", "контракт", "философия", "горло", "оборот", "кость", "ведомство", "преимущество", "мина", "полномочие"
]
